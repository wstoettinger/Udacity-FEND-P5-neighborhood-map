...
function initMap() {
  ...
  google.maps.event.addListener(autocomplete, 'place_changed', function () {
    ...
    if (tempMarker.marker)
      tempMarker.marker.setVisible(false);
    ...
    if (!place.geometry) {
      ...
      tempMarker.marker.setIcon( /** @type {google.maps.Icon} */ ({
        url: place.icon,
      ...
      tempMarker.marker.setPosition(place.geometry.location);
      tempMarker.marker.setVisible(true);
      ...
      mapInfo.setContent('<div><strong>' + place.name + '</strong><br>' + address);
      mapInfo.open(map, tempMarker.marker);
    }
  });
